...
class CountryStatus implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CountryStatus';
     ...
     * Sets availability.
     *
     * @param  null|string  $availability  availability
     *
     * @return self
     */
